...
function readState() {
  if (!fs.existsSync(STATE_FILE))
    return { status: "RUNNING", current_sprint: 1, active_turn: "CEO" };
...
async function loop() {
  ...
  while (true) {
    ...
    if (state.active_turn === "CEO") {
      console.log(
        "👑 CEO is analyzing reports, synthesizing summary, and delegating next sprint tasks...",
      );
      ...
      console.log(
        "✅ All Managers submitted reports. Advancing sprint and triggering CEO summary...\n",
      );
