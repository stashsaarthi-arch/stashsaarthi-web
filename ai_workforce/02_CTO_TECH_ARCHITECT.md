...
- **Auto-Fix Protocol:**
  - Directly refactor messy components into clean, performant modules.
  - Optimize DOM trees and add GPU acceleration tags (`will-change`, `transform: translate3d`) where necessary.
- **Reporting:** Post technical audit reports and completed patch notes to `AGENT_REPORTS.md`.
