# SOP-OPS-02: Tamper-Evident Laser Barcode Seal & Chain-of-Custody Protocol
...
2. **Seal Application:**
   ...
   - The seal is pulled taut until locked.
3. **Dual Barcode Scan & Digital Capture:**
   - Concierge scans the barcode using the StashSaarthi Concierge Web App.
   - 3 timestamped photos are taken: (1) Front view with barcode, (2) Seal lock close-up, (3) Bag placement on elevated pallet.
4. **Instant WhatsApp Receipt:** The student immediately receives an automated WhatsApp message with:
   - High-resolution photo proof
   - Serialized Seal ID (`SS-SEAL-XXXXXX`)
   - Host Node GPS tag & Tuesday Escrow confirmation.
...
2. **Physical Seal Integrity Inspection:**
   ...
   - Inspect the seal for any cuts, stress fractures, or adhesive residue.
3. **Seal Cutting & Handover:**
   - The seal is cut **ONLY in the physical presence of the student**.
   - Student signs the digital handover receipt.
   - Escrow hold is released, and host payout is marked finalized.
...
- If a seal is found broken or mismatched prior to authorized student pickup:
  ...
  - Up to ₹10,000 instant escrow insurance compensation is disbursed to the student within 2 hours under the StashShield guarantee.
