...
console.log(
  "  ✓ hostPushNotifications.ts verified with Web Push & Web Audio API siren synthesizer.",
);
...
console.log(
  "  ✓ HostPushNotificationModal.tsx verified with Siren Alarm & Push Simulation console.",
);
...
if (!adminContent.includes("HostPushNotificationModal") || !adminContent.includes("Push & Siren")) {
  console.error(
    "❌ admin.tsx missing HostPushNotificationModal or Push & Siren button integration!",
  );
  process.exit(1);
}
console.log(
  "  ✓ admin.tsx verified with Host Web Push launcher button & lazy modal component rendering.",
);
...
if (!bookingModalContent.includes("triggerHostPushNotification")) {
  console.error(
    "❌ BookingModal.tsx missing triggerHostPushNotification invocation on booking confirmation!",
  );
  process.exit(1);
}
console.log(
  "  ✓ BookingModal.tsx verified with auto-triggering host push notification & persistent alert siren.",
);
