...
if (!kycEngineContent.includes('XXXX-XXXX-') || !kycEngineContent.includes('police_clearance')) {
  console.error('❌ DPDP Act Aadhaar masking or police clearance specs missing in hostKycEngine.ts');
  process.exit(1);
}
...
if (!kycModalContent.includes('export function HostKycModal') || !kycModalContent.includes('Facial Liveness')) {
