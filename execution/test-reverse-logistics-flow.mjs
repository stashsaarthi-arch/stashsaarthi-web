...
assert(
  engineContent.includes("createProxyHandoverAuthorization"),
  "Engine exports createProxyHandoverAuthorization",
);
assert(engineContent.includes("verifyProxyHandoverCode"), "Engine exports verifyProxyHandoverCode");
assert(
  engineContent.includes("confirmProxyHandoverRelease"),
  "Engine exports confirmProxyHandoverRelease",
);
assert(
  engineContent.includes("revokeProxyHandoverAuthorization"),
  "Engine exports revokeProxyHandoverAuthorization",
);
...
assert(
  modalContent.includes("ReverseLogisticsModal"),
  "Modal component is named ReverseLogisticsModal",
);
assert(modalContent.includes("OfflineQrCode"), "Modal renders dynamic QR pass code");
assert(
  modalContent.includes("WhatsApp"),
  "Modal features WhatsApp referral / notification trigger",
);
assert(
  modalContent.includes("Runner Verification Terminal"),
  "Modal includes runner verification terminal tab",
);
...
assert(
  adminContent.includes("stashsaarthi:open-reverse-logistics"),
  "admin.tsx handles stashsaarthi:open-reverse-logistics event",
);
assert(
  adminContent.includes("Proxy Handover"),
  "admin.tsx contains Proxy Handover toolbar launcher button",
);
