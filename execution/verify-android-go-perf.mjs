...
try {
  ...
  assert(
    card3dContent.includes("ontouchstart") ||
      card3dContent.includes("maxTouchPoints") ||
      card3dContent.includes("isLowData") ||
      card3dContent.includes("low-data"),
...
console.log("----------------------------------------------------------------");
console.log(
  `📊 SUMMARY: ${totalPassed}/${totalTests} Android Go Performance Safety Assertions Passed.`,
);
console.log("----------------------------------------------------------------");
