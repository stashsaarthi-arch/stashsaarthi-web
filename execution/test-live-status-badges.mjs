...
if (!fs.existsSync(hookPath)) {
  ...
  if (
    !content.includes("item_received") ||
    !content.includes("in_secure_locker") ||
    !content.includes("ready_for_retrieval")
  ) {
...
if (
  ...
  !fs.readFileSync(dashboardPath, "utf-8").includes("BookingLiveStatusBadge")
) {
...
if (
  ...
  !fs.readFileSync(drawerPath, "utf-8").includes("BookingLiveStatusBadge")
) {
