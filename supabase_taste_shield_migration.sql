-- ============================================================================
-- StashSaarthi Anti-Fraud Taste Shield & Meal Review System Migration
-- Run this script in the Supabase SQL Editor:
-- https://supabase.com/dashboard/project/vzwtappbltaplumazupb/sql
-- ============================================================================
...
ON user_shield_quotas FOR SELECT TO anon, authenticated USING (true);
...
ON user_shield_quotas FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
