...
export const translations = {
  en: {
    ...
    campusNodeChecker: {
      ...
      noResults:
        "No live node found for this search. Try searching 208016, IIT Kanpur, or Kalyanpur.",
    },
    roleLane: {
      student: {
        ...
        blurb:
          "Built for hostel exits, semester breaks and internship shifts — store what you own, land a broker-free room and never miss a home-cooked meal.",
        cta: "Start with ₹300/mo storage",
        steps: [
          {
            title: "Stash your bags",
            text: "Doorstep pickup, sealed bins, insured storage from ₹300/month.",
          },
          {
          ...
          },
          {
            ...
            text: "Home-cooked meals from the same neighbourhood kitchens.",
          },
        ],
        metrics: [
      ...
      host: {
        ...
        steps: [
          {
            title: "List the spare room",
            text: "Our concierge visits, photographs and prices it for you.",
          },
          {
            title: "We screen the student",
    ...
    calculator: {
      ...
      subtitle:
        "See how much money you save by choosing StashSaarthi instead of paying empty room rent.",
      ...
      savingsProofBtn: "Savings Proof",
      certificateTitle: "Official Dead-Rent Savings Audit",
      verifiedBadge: "VERIFIED",
      certificateAuditId: "Audit Certificate ID:",
      certificateDuration: "Vacation Duration:",
      certificateEmptyRent: "Empty Room Rent Waste:",
      certificateStashFee: "StashSaarthi Escrow Fee:",
      certificateNetSavings: "Total In-Pocket Savings:",
      printPdf: "Print / PDF",
      lockSavingsCert: "Lock This Savings",
      bagsAria: "Number of luggage bags to store",
      daysAria: "Vacation duration in days",
      rentAria: "Current monthly PG or room rent in rupees",
    },
    hostSimulator: {
    ...
    rooms: {
      ...
      subtitle:
        "Listed by departing students, reviewed honestly, connected directly to the owner. Zero brokerage.",
      filters: [
      ...
      vacatingDesc:
        "List it in 3 steps and earn ₹200 StashCredit toward your next storage booking.",
    ...
    zeroRisk: {
      ...
      subtitle:
        "Deterministic physical and financial safeguards engineered for complete peace of mind.",
      tabs: {
    ...
    hostRulesSection: {
      ...
      subtitle:
        "Design your custom House Norms Matrix. You decide who stays, what rules apply, and when you want your room back.",
      rules: [
        {
          title: "10:00 PM Main Gate Curfew",
          desc: "Host locks main exterior gate at night. No late night entry without prior written notice.",
        },
        {
          title: "Zero Alcohol, Smoking & Unverified Guests",
          desc: "Strictly non-negotiable. Only registered student tenant allowed on premises.",
        },
        {
          title: "Quiet Study Hours (10:00 PM – 7:00 AM)",
          desc: "Headphones required. No loud phone calls or musical instruments during sleeping hours.",
        },
        {
          title: "Private Master Bedroom Smart-Locked",
          desc: "Elder master bedroom remains 100% private zone. Student restricted to designated room & common area.",
        },
        {
          title: "Vegetarian / Respectful Kitchen Etiquette",
          desc: "Shared refrigerator & kitchen shelves clearly demarcated with strict cleanliness guidelines.",
        },
      ],
      activeCounter: "of 5 Norms Active in Agreement",
      guaranteeTitle: "24-Hour Relocation Guarantee",
      guaranteeDesc:
        "If a student violates any active rule on your matrix, StashSaarthi's rapid ops fleet relocates them within 24 hours at zero loss of rent to you.",
    ...
    familyDashboardSection: {
      ...
      subtitle:
        "Total peace of mind knowing your parents are safe, accompanied, and physically protected 24×7.",
      features: [
        {
          title: "Remote Family Dashboard",
          desc: "Live monitoring of verified student check-ins and ratings directly on your phone.",
        },
        {
      ...
      stages: [
        {
          label: "Step 1",
          title: "Immediate App & Beacon Ping",
          desc: "Bedside beacon fires live geo-coordinates to local Kanpur nodal manager (0.4s).",
        },
        {
          label: "Step 2",
          title: "Student Roommate & Nodal Dispatch",
          desc: "Verified student in house alerted immediately; local manager dispatched (1.2s).",
        },
        {
          label: "Step 3",
          title: "Family Connected on WhatsApp",
          desc: "Son/daughter in Delhi/Bengaluru receives automatic audio call & live status (2.4s).",
        },
      ],
    },
    storiesSection: {
    ...
    footer: {
      ...
      subtitle:
        "Join the priority list for your city — stash spots, verified rooms and home kitchens open in batches.",
      student: "Student",
      host: "Host",
      name: "Full name",
      ...
      copyright:
        "© 2026 StashSaarthi. All rights reserved. Illustrative pricing and listings shown for demonstration.",
    },
  },
  hi: {
    nav: {
    ...
    roleLane: {
      student: {
        ...
        blurb:
          "हॉस्टल खाली करने, छुट्टियों और इंटर्नशिप के लिए निर्मित — अपना सामान सुरक्षित रखें, बिना ब्रोकर के कमरा पाएं और घर का खाना कभी न छोड़ें।",
        cta: "₹300/माह स्टोरेज से शुरू करें",
        steps: [
          {
            title: "बैग सुरक्षित रखें",
            text: "घर से पिकअप, सीलबंद बैग, ₹10,000 बीमा सुरक्षित मात्र ₹300/माह में।",
          },
          {
            title: "सत्यापित कमरा पाएं",
            text: "कैंपस के पास वरिष्ठ नागरिकों के सुरक्षित घरों में शून्य ब्रोकरेज कमरे।",
          },
          {
            title: "घरेलू टिफिन लें",
            text: "उसी मोहल्ले की रसोई से तैयार शुद्ध व स्वच्छ घर का खाना।",
          },
        ],
        metrics: [
      ...
      host: {
        ...
        blurb:
          "आपका खाली कमरा बन जाता है नियमित आय और दैनिक साथ का जरिया — हम हर छात्र का बैकग्राउंड चेक करते हैं और पूरी जिम्मेदारी संभालते हैं।",
        cta: "खाली कमरा मुफ्त लिस्ट करें",
        steps: [
          {
            title: "खाली कमरा लिस्ट करें",
            text: "हमारी टीम आपके घर आकर फोटो लेगी और सही किराया तय करेगी।",
          },
          {
            title: "सत्यापित छात्र का चयन",
            text: "किसी भी विज़िट से पहले 3-स्तरीय आईडी, कॉलेज और पुलिस सत्यापन।",
          },
          {
            title: "साथ और सामंजस्य",
            text: "दैनिक दिनचर्या, भाषा और संस्कारों के आधार पर सुरक्षित मैचिंग।",
          },
        ],
        metrics: [
    ...
    calculator: {
      ...
      subtitle:
        "देखें कि खाली कमरे का किराया देने के बजाय स्टैशसारथी चुनकर आप कितने पैसे बचाते हैं।",
      ...
      savingsProofBtn: "बचत रसीद",
      certificateTitle: "आधिकारिक डेड-रент बचत प्रमाणपत्र",
      verifiedBadge: "सत्यापित",
      certificateAuditId: "प्रमाणपत्र आईडी:",
      certificateDuration: "अवधि (वेकेशन):",
      certificateEmptyRent: "पारंपरिक खाली कमरा किराया:",
      certificateStashFee: "सार्थी स्टैश लागत (₹300/बैग):",
      certificateNetSavings: "सीधी छात्र जेब बचत:",
      printPdf: "प्रिंट / PDF",
      lockSavingsCert: "यह बचत सुरक्षित करें",
      bagsAria: "स्टोर करने के लिए बैगों की संख्या",
      daysAria: "छुट्टियों की अवधि (दिन)",
      rentAria: "वर्तमान मासिक कमरा किराया",
    },
    hostSimulator: {
      titlePart1: "अपनी",
    ...
    rooms: {
      ...
      subtitle:
        "जाने वाले छात्रों द्वारा लिस्टेड, ईमानदारी से समीक्षित, सीधे मालिक से संपर्क। शून्य ब्रोकरेज।",
      filters: [
      ...
      vacatingDesc:
        "इसे 3 चरणों में लिस्ट करें और अपनी अगली स्टोरेज बुकिंग पर ₹200 स्टैशक्रेडिट पाएं।",
    ...
    zeroRisk: {
      ...
      barcodeSimulator: {
        ...
        subtitle:
          "पिकअप के समय हर संग्रहीत बैग को लेजर-उत्कीर्ण गैर-फाड़ने योग्य बारकोड से सील किया जाता है।",
    ...
    hostRulesSection: {
      ...
      subtitle:
        "अपने घर के अनुसार नियम बनाएं। आप तय करते हैं कि कौन रहेगा, क्या नियम लागू होंगे और कब आपको कमरा वापस चाहिए।",
      rules: [
        {
          title: "रात 10:00 बजे मुख्य द्वार बंद",
          desc: "होस्ट रात में मुख्य गेट बंद करते हैं। पूर्व सूचना के बिना देर रात प्रवेश की अनुमति नहीं है।",
        },
        {
          title: "शराब, धूम्रपान और अनजान मेहमान पूर्णतः वर्जित",
          desc: "सख्ती से अनिवार्य नियम। परिसर में केवल पंजीकृत छात्र किराएदार को ही अनुमति है।",
        },
        {
          title: "शांत अध्ययन समय (रात 10:00 – सुबह 7:00)",
          desc: "हेडफोन आवश्यक। सोने के समय तेज आवाज में फोन कॉल या संगीत की अनुमति नहीं।",
        },
        {
          title: "निजी मास्टर बेडरूम स्मार्ट-लॉक्ड",
          desc: "बुजुर्गों का मुख्य कमरा 100% निजी रहता है। छात्र केवल अपने कमरे व साझा क्षेत्र तक सीमित हैं।",
        },
        {
          title: "शाकाहारी / स्वच्छ रसोई शिष्टाचार",
          desc: "साझा रेफ्रिजरेटर और अलमारी स्पष्ट रूप से स्वच्छता दिशानिर्देशों के साथ विभाजित हैं।",
        },
      ],
      activeCounter: "में से 5 नियम समझौते में सक्रिय",
      guaranteeTitle: "24-घंटे रीलोकेशन गारंटी",
      guaranteeDesc:
        "यदि कोई छात्र आपके किसी भी सक्रिय नियम का उल्लंघन करता है, तो सार्थी टीम 24 घंटे के भीतर बिना आपके किराए के नुकसान के उसे रीलोकेट करती है।",
    ...
    familyDashboardSection: {
      ...
      subtitle:
        "यह जानकर पूर्ण मानसिक शांति कि आपके माता-पिता 24×7 सुरक्षित, साथ में और संरक्षित हैं।",
      features: [
        {
          title: "रिमोट फैमिली डैशबोर्ड",
          desc: "अपने फोन पर सत्यापित छात्र के चेक-इन और रेटिंग की लाइव निगरानी।",
        },
        {
          title: "24/7 त्वरित आपातकालीन प्रतिक्रिया",
          desc: "तत्काल सहायता के लिए स्थानीय नोडल प्रबंधकों से जुड़ा 1-टच बेडसाइड एसओएस बटन।",
        },
        {
          title: "डिजिटल साथी",
          desc: "छात्र स्मार्टफोन तकनीक, दवाइयां मंगाने और छोटे-मोटे घरेलू कामों में मदद करते हैं।",
        },
      ],
      ...
      stages: [
        {
          label: "चरण 1",
          title: "तत्काल ऐप एवं बीकन सिग्नल",
          desc: "बेडसाइड बीकन स्थानीय कानपुर नोडल मैनेजर को लाइव जीपीएस भेजता है (0.4s)।",
        },
        {
          label: "चरण 2",
          title: "छात्र साथी एवं नोडल टीम अलर्ट",
          desc: "घर में मौजूद सत्यापित छात्र तुरंत अलर्ट होता है; स्थानीय मैनेजर रवाना (1.2s)।",
        },
        {
          label: "चरण 3",
          title: "परिवार WhatsApp पर कनेक्ट",
          desc: "दिल्ली/बेंगलुरु में बेटे/बेटी को स्वचालित ऑडियो कॉल व लाइव स्थिति मिलती है (2.4s)।",
        },
      ],
    },
    storiesSection: {
    ...
    faqSection: {
      ...
      subtitle:
        "हम जानते हैं कि विश्वास कमाया जाता है। यहां जानें कि हम हर कठिन परिस्थिति को कैसे संभालते हैं।",
      ...
      noResults:
        "कोई मेल खाता प्रश्न नहीं मिला। आप हमारे 24×7 कंसीयज से सीधे WhatsApp पर पूछ सकते हैं।",
    },
    footer: {
      title: "एक ऐसा शहर जहां कोई अकेला नहीं आता।",
      subtitle:
        "अपने शहर की प्राथमिकता सूची में शामिल हों — स्टैश स्पॉट, सत्यापित कमरे और घर की रसोई बैचों में खुलते हैं।",
      student: "छात्र",
      host: "होस्ट",
      name: "पूरा नाम",
      email: "you@college.edu",
      ...
      waiver:
        "मैं सहमत हूं कि संग्रहीत सामान में सार्थी सुरक्षा चार्टर के अनुसार कोई निषिद्ध/खतरनाक वस्तु नहीं है।",
      ...
      copyright:
        "© 2026 StashSaarthi. सर्वाधिकार सुरक्षित. दिखाए गए मूल्य केवल प्रदर्शन के लिए हैं।",
    },
  },
};
