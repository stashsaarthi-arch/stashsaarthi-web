...
const PW_CONFIG: HubConfig = {
  ...
  heroDescription:
    "Pure homestyle tiffin service cooked by verified senior mothers in Kakadeo Kanpur. Located just 80 meters from Physics Wallah (PW) Vidyapeeth Chhapeda Pulia Center. Fresh hot phulkas, zero commercial preservatives, and flexible meal token system for PW students.",
  distance: "80 meters",
  ...
  metaDescription:
    "Best homestyle tiffin service near Physics Wallah (PW) Vidyapeeth Kakadeo Kanpur. Pure home-cooked meals from ₹50 cooked by senior mothers. Zero palm oil, 1-tap pause feature for NEET & JEE students.",
  metaKeywords:
  ...
  chefName: "Annapurna Senior Home Kitchen (PW Lane)",
  chefBio: "Managed by Sunita Sharma Ji and local senior homemakers. Serving hygienic, less-oil homemade thalis to 400+ Physics Wallah students daily.",
  rating: 4.8,
  totalOrders: "15,800+",
  activeStudents: 410,
  highlightReview: {
    ...
    comment:
      "PW Vidyapeeth Kakadeo classes run long. Sunita Aunty's tiffin is right behind PW lane. The food tastes exactly like my mom's cooking in Prayagraj—clean, non-oily, and super affordable at ₹50!",
    stars: 5,
  },
};
