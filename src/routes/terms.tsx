      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mb-8 text-center sm:text-left">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
            {isHi
              ? "सेवा की शर्तें एवं आचार संहिता (Terms of Service)"
              : "Terms of Service & Operating Charter"}
          </h1>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div className="sticky top-20 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md">
              ...
              <nav className="space-y-1 text-xs">
                {[
                  {
                    id: "eligibility",
                    label: isHi ? "1. पात्रता व दायरा" : "1. Eligibility & Scope",
                  },
                  {
                    id: "tpa",
                    label: isHi ? "2. TPA 1882 कानूनी ढांचा" : "2. TPA Sec 105 Framework",
                  },
                  {
                    id: "prohibited",
                    label: isHi ? "3. प्रतिबंधित वस्तुएं" : "3. Prohibited Storage Items",
                  },
                  {
                    id: "escrow",
                    label: isHi ? "4. एस्क्रो व रिफंड SLA" : "4. Escrow & Refund SLA",
                  },
                  {
                    id: "insurance",
                    label: isHi ? "5. ₹10k माइक्रो-बीमा" : "5. ₹10k Micro-Insurance",
                  },
                  {
                    id: "hostcode",
                    label: isHi ? "6. सीनियर होस्ट अधिकार" : "6. Host Rules & Dignity",
                  },
                  {
                    id: "cancellation",
                    label: isHi ? "7. शून्य कैंसिलेशन फीस" : "7. Zero Cancellation Policy",
                  },
                  {
                    id: "disputes",
                    label: isHi ? "8. विवाद निवारण" : "8. Jurisdiction & Disputes",
                  },
                ].map((item) => (
                  <a
                    key={item.id}
          ...
          <div className="md:col-span-3 space-y-8 text-sm leading-relaxed text-slate-300">
            ...
            >
              ...
              <p>
                By accessing StashSaarthi web applications, reserving micro-storage, listing a
                co-living room, or subscribing to Saarthi Kitchen tiffins, you enter into a binding
                agreement with StashSaarthi Technologies.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs pt-1">
                <div className="rounded-xl border border-white/10 bg-black/40 p-3">
                  <h3 className="font-bold text-emerald-400 mb-1">A. Saarthi Stash</h3>
                  <p className="text-muted-foreground">
                    Vacation micro-storage at ₹300/bag/mo with elevated wooden pallet placement,
                    laser tamper barcode seals, and ₹10k insurance.
                  </p>
                </div>
                <div className="rounded-xl border border-white/10 bg-black/40 p-3">
                  <h3 className="font-bold text-amber-400 mb-1">B. Saarthi Spaces</h3>
                  <p className="text-muted-foreground">
                    Zero-brokerage student room stays with verified verified PG owner households
                    under transparent month-to-month leave-and-license agreements.
                  </p>
                </div>
                <div className="rounded-xl border border-white/10 bg-black/40 p-3">
                  <h3 className="font-bold text-cyan-400 mb-1">C. Saarthi Kitchen</h3>
                  <p className="text-muted-foreground">
                    Pure home-cooked tiffin meals prepared by verified neighborhood verified PG
                ...
                <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-3 sm:col-span-2">
                  ...
                  <p className="text-amber-100/90">
                    ...
                    user experience (Student vs Host view) based on interaction signals. Zero
                    behavioral telemetry is stored on external servers or sold to third parties.
                    Users can toggle "Low-Data Mode" at any time to bypass animations and
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-1.5 text-xs text-amber-200/80">
                <li>
                  <strong className="text-amber-300">Non-Tenancy Protection:</strong> License
                  agreements grant temporary permissive occupancy only. They do not create permanent
                  tenancy, leasehold equity, or property encumbrance rights.
                </li>
                <li>
                  <strong className="text-amber-300">Verified PG Owner Dignity Guard:</strong>{" "}
                  Verified PG Owner hosts maintain 100% legal ownership and authority to enforce
                  house norms, quiet hours (e.g. after 10:00 PM), and visitor entry policies.
                </li>
                <li>
                  <strong className="text-amber-300">24-Hour Relocation SLA:</strong> In case of
                  irreconcilable roommate friction, StashSaarthi provides zero-penalty student
                  relocation to an alternate verified node within 24 hours.
                </li>
              </ul>
            </section>
            ...
            >
              ...
              <p className="text-red-200">
                To preserve physical safety across verified PG owner host households, students must
                strictly inspect luggage prior to laser sealing.
              </p>
              <div className="rounded-xl border border-red-500/20 bg-black/40 p-3 space-y-2 text-xs">
                <p className="font-bold text-red-400">
                  Strictly Prohibited Items (Zero Exception):
                </p>
                <ul className="list-disc pl-5 space-y-1 text-slate-300">
                  ...
                  <li>
                    Perishable food items, cooked meals, or unsealed liquids liable to rot or leak.
                  </li>
                  <li>
                    Flammable liquids, gas cylinders, fireworks, batteries liable to swelling, or
                    hazardous chemicals.
                  </li>
                  <li>
                    Unlawful contraband, weapons, firearms, or substances prohibited under Indian
                    Penal Code (IPC) or NDPS Act.
                  </li>
                </ul>
                <p className="text-red-300/90 text-[11px] pt-1">
                  ⚡ <strong>Laser Barcode Mandate:</strong> Every luggage bag is physically
                  weight-checked and sealed with a uniquely numbered tamper-evident laser barcode
                  seal (#SS-KNP-XXXX) in your presence during pickup.
                </p>
              </div>
            </section>
            ...
            >
              ...
              <p>
                StashSaarthi operates with 100% digital bank escrow protection for both students and
                host keepers:
              </p>
              <ul className="list-disc pl-5 space-y-1.5 text-xs text-muted-foreground">
                <li>
                  <strong className="text-white">Host Escrow Payouts:</strong> Student booking fees
                  are held in escrow and released directly to verified PG owner host bank accounts
                  on a weekly schedule (every Monday) following conflict-free handover.
                </li>
                <li>
                  <strong className="text-white">100% Pre-Pickup Cancellation Refund:</strong>{" "}
                  Cancellations made up to 24 hours prior to scheduled doorstep luggage pickup or
                  stay move-in receive an instant 100% full refund with zero deduction fees.
                </li>
                <li>
                  <strong className="text-white">Pro-Rata Early Withdrawal Return:</strong> If you
                  return to campus early and withdraw stored luggage mid-vacation, unused whole
                  months are refunded pro-rata directly to your bank account within 3–5 working
                  days.
                </li>
              </ul>
            </section>
            ...
            >
              ...
              <p>
                Every stored luggage bag carrying an intact laser barcode seal is automatically
                covered under our ₹10,000 Micro-Insurance Charter against physical damage, water
                ingress, or theft during node custody.
              </p>
              <div className="rounded-xl border border-white/10 bg-black/40 p-3 space-y-1 text-xs text-muted-foreground">
                <p>
                  <strong className="text-white">Elevation Audit:</strong> Host nodes are audited to
                  ensure luggage is stored on raised wooden/polymer pallets (min 2.5 ft elevation)
                  in dry, clean room zones.
                </p>
                <p>
                  <strong className="text-white">Broken Seal Protocol:</strong> If a barcode seal is
                  found tampered or broken upon doorstep return delivery, an immediate claim ticket
                  is registered, and compensation up to ₹10,000 is settled within 48 hours following
                  physical assessment.
                </p>
              </div>
            </section>
            ...
            >
              ...
              <p>
                Verified PG Owner hosts are respected community partners generating tech-enabled
                passive income from spare household capacity:
              </p>
              <ul className="list-disc pl-5 space-y-1.5 text-xs text-muted-foreground">
                <li>
                  <strong className="text-white">Zero Intrusion Guarantee:</strong> Student luggage
                  is stored in designated spare storage rooms or corner zones. Hosts will never
                  inspect, open, or move sealed luggage without explicit student consent.
                </li>
                <li>
                  <strong className="text-white">Respectful Interaction:</strong> Students residing
                  in co-living rooms or taking home-cooked tiffins must observe household quiet
                  hours and treat premium hosts with utmost respect.
                </li>
                <li>
                  <strong className="text-white">0% Platform Listing Fee:</strong> Hosts enjoy 0%
                  onboarding fees, with transparent payouts disbursing ₹180 out of every ₹300
                  storage bag.
                </li>
              </ul>
            </section>
            ...
            >
              ...
              <p className="text-emerald-100">
                We believe in radical fairness. There are zero hidden processing charges, zero
                convenience fee forfeitures, and zero cancellation penalties when you modify or
                cancel a booking with appropriate notice.
              </p>
            </section>
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">
                This agreement is governed by the laws of India. Any legal disputes or claims shall
                be subject to the exclusive jurisdiction of courts in Kanpur, Uttar Pradesh, India.
              </p>
              ...
              <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-xs space-y-2">
                ...
                <div className="space-y-1 text-slate-300 pt-1">
                  <p className="flex items-center gap-2">
                    ...
                    <span>
                      Operational Hub: 117/K-Block, Kalyanpur, Kanpur, Uttar Pradesh — 208016, India
                    </span>
                  </p>
                  <p className="flex items-center gap-2">
                    ...
                    <span>
                      Direct Email:{" "}
                      <a href="mailto:stashsaarthi@gmail.com" className="text-amber-400 underline">
