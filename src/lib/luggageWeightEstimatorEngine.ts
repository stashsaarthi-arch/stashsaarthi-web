...
export const LUGGAGE_ITEMS_DATABASE: LuggageItem[] = [
  ...
  {
    id: "blanket",
    name: "Heavy Blanket / Quilt (Razaai)",
    nameHi: "कंबल / रजाई",
    category: "clothing",
    weightKg: 2.8,
    iconName: "Bed",
  ...
  {
    id: "bedsheet",
    name: "Bed Sheet & Pillow",
    nameHi: "चादर एवं तकिया",
    category: "clothing",
    weightKg: 1.1,
    iconName: "Bed",
  },
  ...
  {
    id: "book_heavy",
    name: "GATE / JEE Heavy Textbook",
    nameHi: "मोटी किताब (JEE/GATE)",
    category: "study",
    weightKg: 1.4,
    iconName: "BookOpen",
  },
  ...
  {
    id: "cooker",
    name: "Pressure Cooker / Induction",
    nameHi: "प्रेशर कुकर / इंडक्शन",
    category: "kitchen",
    weightKg: 2.7,
    iconName: "Utensils",
  },
  {
    id: "utensils",
    name: "Utensils Set (Plates/Pans)",
    nameHi: "बर्तन सेट (थाली/पतीला)",
    category: "kitchen",
    weightKg: 1.8,
    iconName: "Utensils",
  },
  ...
  {
    id: "toiletries",
    name: "Toiletries & Cosmetics Bag",
    nameHi: "टॉयलेटरीज़ एवं किट",
    category: "misc",
    weightKg: 0.85,
    iconName: "Sparkles",
  },
