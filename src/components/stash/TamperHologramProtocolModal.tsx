...
export const TamperHologramProtocolModal: React.FC<TamperHologramProtocolModalProps> = ({
  ...
  const [statusFilter, setStatusFilter] = useState<"ALL" | "INTACT" | "INSPECTED" | "TAMPERED">(
    "ALL",
  );
  ...
  const liveHash = generateHologramSecuritySealHash(
    hologramCode || "HOL-SAMPLE",
  ...
  const handleLinkHologram = (e: React.FormEvent) => {
    ...
    if (res.success) {
      toast.success(
        isHi
          ? "टैम्पर होलोग्राम सील सफलतापूर्वक लॉक हुई!"
          : "Tamper Hologram Seal Linked & Locked!",
        {
  ...
  const handleUpdateStatus = (
    code: string,
    newStatus: "INTACT" | "INSPECTED" | "TAMPERED" | "VOIDED",
  ) => {
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-white tracking-wide">
                  {isHi
                    ? "टैम्पर-प्रूफ होलोग्राम प्रोटोकॉल कंसोल"
                    : "Tamper-Proof Hologram Protocol Engine"}
                </h2>
                  ...
                  <div className="relative h-44 rounded-lg bg-black/90 border border-zinc-800 flex flex-col items-center justify-center overflow-hidden">
                    ...
                    <div className="border-2 border-dashed border-emerald-500/50 rounded-lg p-6 flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs text-zinc-400 font-mono">
                        {isHi
                          ? "भौतिक होलोग्राम टेप बारकोड स्कैन करें"
                          : "Scan Physical Hologram Barcode Tape"}
                      </span>
                    </div>
              ...
              <form onSubmit={handleLinkHologram} className="lg:col-span-7 space-y-4">
                <div className="p-5 rounded-xl bg-zinc-900/60 border border-zinc-800 space-y-4">
                  <h3 className="text-sm font-semibold text-white flex items-center gap-2">
                    ...
                    {isHi
                      ? "स्टैश आइटम से होलोग्राम लिंक विवरण"
                      : "Luggage & Hologram Custody Record Details"}
                  </h3>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={
                        isHi
                          ? "जैसे लेजर होलोग्राम सील सही सलामत लगाई गई"
                          : "e.g. Hologram tape sealed intact on 2 cartons."
                      }
                      className="w-full px-3 py-2 rounded-lg bg-black border border-zinc-700 text-white text-sm focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                  ...
                  >
                    <Lock className="w-4 h-4" />
                    {isHi
                      ? "🔒 होलोग्राम सुरक्षा लॉक रिकॉर्ड सेव करें"
                      : "🔒 Lock Hologram Custody Record"}
                  </button>
                </div>
              </form>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
                  <div className="text-xs text-zinc-400">
                    {isHi ? "कुल होलोग्राम टेप" : "Total Hologram Seals"}
                  </div>
                ...
                <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
                  <div className="text-xs text-emerald-400">
                    {isHi ? "सही सलामत (Intact)" : "Intact & Inspected"}
                  </div>
                ...
                <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
                  <div className="text-xs text-amber-400">
                    {isHi ? "छेड़छाड (Tampered)" : "Tampered Alerts"}
                  </div>
                ...
                <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800">
                  <div className="text-xs text-cyan-400">
                    {isHi ? "सुरक्षा स्कोर" : "Security Rating Score"}
                  </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-72">
                  ...
                  <input
                    ...
                    placeholder={
                      isHi ? "खोजें (कोड, नाम, बुकिंग ID)..." : "Search code, student, booking..."
                    }
              ...
              <div className="space-y-3">
                {filteredRecords.length === 0 ? (
                  <div className="p-8 text-center bg-zinc-900/40 rounded-xl border border-zinc-800 text-zinc-500 text-sm">
                    {isHi
                      ? "कोई होलोग्राम रिकॉर्ड नहीं मिला।"
                      : "No matching hologram records found."}
                  </div>
                ) : (
            ...
            <div className="space-y-6 text-sm text-zinc-300">
              <div className="p-5 rounded-xl bg-gradient-to-r from-emerald-950/50 via-zinc-900 to-zinc-950 border border-emerald-500/30 space-y-3">
                <div className="flex items-center gap-2 text-emerald-400 font-bold text-base">
                  ...
                  {isHi
                    ? "StashSaarthi CSO भौतिक सुरक्षा टेप मानक"
                    : "StashSaarthi CSO Physical Security Tape Standard"}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    High-diffraction 3D optical foil displaying StashSaarthi official seal
                    watermark, preventing counterfeit substitution.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    Pressure-sensitive acrylic adhesive layer that breaks into permanent "VOID
                    OPENED" text upon thermal or physical peeling.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    Unique sequential laser-etched serial code (e.g. STASH-HOL-889421) linked 1-to-1
                    with student custody ticket.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    If hologram seal is tampered upon doorstep return delivery, ₹10,000
                    micro-insurance claim is instantly processed within 48 hours.
                  </p>
                </div>
              </div>
            </div>
