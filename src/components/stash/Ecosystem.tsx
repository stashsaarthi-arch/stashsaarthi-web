                ...
                <div className="glass overflow-hidden rounded-2xl">
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <div className="border-t border-white/10 p-3.5 sm:p-5">
                          <p className="text-xs leading-relaxed text-muted-foreground sm:text-sm">
                            {textData.subtitle}
                          </p>
                          <div
                            className="mt-3 rounded-xl border border-white/10 p-2.5 text-xs"
                            style={{
                          ...
                          <Button
                            variant="hero"
                            size="default"
                            className="mt-4 w-full sm:w-auto cursor-pointer text-xs sm:text-sm py-2 px-4"
