...
const SERVICE_TITLES: Record<string, { en: string; hi: string; icon: string }> = {
  stash: {
    en: "Saarthi Stash — Micro Luggage Storage",
    hi: "सारथी स्टैश — लगेज स्टोरेज",
    icon: "🎒",
  },
  spaces: { en: "Saarthi Spaces — Co-Living Stay", hi: "सारथी स्पेस — को-लिविंग स्टे", icon: "🏠" },
  kitchen: {
    en: "Saarthi Kitchen — Homestyle Tiffin",
    hi: "सारथी किचन — होमस्टाइल टिफिन",
    icon: "🍲",
  },
  ...
  micro: {
    en: "Saarthi Micro — Luggage Storage",
    hi: "सारथी माइक्रो — माइक्रो स्टोरेज",
    icon: "📦",
  },
            ...
            >
              ...
              <div className="p-6 border-b border-white/10 bg-black/40 relative">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full border font-bold ${statusConfig.style}`}
                  >
                ...
                <div className="bg-gradient-to-br from-cyan-950/40 via-black/50 to-emerald-950/30 border border-cyan-500/30 rounded-2xl p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-cyan-400 text-xs font-bold uppercase tracking-wider">
                      ...
                      <span>
                        {isHi ? "ऑफ़लाइन पिकअप/ड्रॉप QR पास" : "Offline Pickup/Drop QR Pass"}
                      </span>
                    </div>
                  ...
                  <div className="flex items-center gap-4 bg-black/60 border border-white/10 rounded-xl p-3">
                    ...
                    >
                      <OfflineQrCode
                        value={booking.token}
                        size={88}
                        className="border border-cyan-500/40 group-hover:scale-105 transition-transform"
                      />
                    ...
                    <div className="space-y-1 text-xs min-w-0">
                      ...
                      <p className="text-[10px] text-emerald-400 font-mono flex items-center gap-1 pt-1">
                        ...
                        <span>
                          {isHi
                            ? "बिना इंटरनेट के कार्य करता है"
                            : "Works without cellular internet"}
                        </span>
                      </p>
                      <button
                        type="button"
                ...
                <div className="bg-black/50 border border-white/10 rounded-2xl p-4 space-y-3">
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    {booking.bags !== undefined && (
                      <div className="flex justify-between text-slate-300">
                        <span className="text-slate-400">
                          {isHi ? "स्टोरेज बैग संख्या:" : "Storage Bag Count:"}
                        </span>
                        <span>
                          {booking.bags} {isHi ? "बैग" : "bags"}
                        </span>
                      </div>
                    )}
                    ...
                    {booking.months !== undefined && (
                      <div className="flex justify-between text-slate-300">
                        ...
                        <span>
                          {booking.months} {isHi ? "महीने" : "months"}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between text-slate-300">
                      <span className="text-slate-400">
                        {isHi ? "सुरक्षा एस्क्रो शुल्क:" : "Escrow Safety Cover:"}
                      </span>
                      <span className="text-emerald-400 font-semibold">
                        {isHi ? "₹0 (मुफ़्त ₹10k कवर)" : "₹0 (Free ₹10k Cover)"}
                      </span>
                    </div>

                    <div className="flex justify-between text-slate-300 pt-2 border-t border-white/5">
                      <span className="text-slate-400">
                        {isHi ? "भुगतान विधि:" : "Payment Mode:"}
                      </span>
                      ...
                      >
                        {downloadingPdf ? (
                          <>
                            ...
                            <span>
                              {isHi ? "PDF जनरेट हो रहा है..." : "Generating GST Invoice PDF..."}
                            </span>
                          </>
                        ) : (
                          <>
                            ...
                            <span>
                              {isHi
                                ? "GST टैक्स चालान PDF डाउनलोड करें"
                  ...
                  <div className="text-xs space-y-2 text-slate-300">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-white">
                          {isHi
                            ? "सुधा त्रिपाठी जी (वरिष्ठ होस्ट)"
                            : "Sudha Tripathi Ji (Verified PG Owner Host)"}
                        </p>
                        <p className="text-[11px] text-slate-400">
                          {isHi
                            ? "सत्यापित 4-स्तरीय सुरक्षा ऑडिट पास"
                            : "Verified 4-Tier Safety Audit Pass"}
                        </p>
                      </div>
                      <Button
                        size="sm"
              ...
              <div className="p-4 border-t border-white/10 bg-black/60 space-y-2">
                ...
                >
                  ...
                  <span>
                    {booking.service === "stash" || booking.service === "micro"
                      ? isHi
                        ? "1-टैप स्लॉट नवीनीकृत करें (Renew Slot)"
                        : "1-Tap Renew Storage Slot"
                      : booking.service === "kitchen" || booking.service === "meal"
                        ? isHi
                          ? "1-टैप टिफिन पुनः ऑर्डर करें (Reorder Pack)"
                          : "1-Tap Reorder Meal Pack"
                        : isHi
                          ? "1-टैप पुनः बुक करें (Rebook)"
                          : "1-Tap Rebook Service"}
                  </span>
                </Button>
                ...
                >
                  ...
                  <span>
                    {isHi
                      ? "अनबॉक्सिंग क्षति दावा प्रस्तुत करें (₹10k कवर)"
                      : "File Unboxing Damage Claim (₹10k Cover)"}
                  </span>
                </Button>
        ...
        <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center animate-in fade-in">
          ...
          >
            ...
            <div className="p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-[11px] text-emerald-300 font-semibold flex items-center justify-center gap-1.5">
              ...
              <span>
                {isHi ? "ऑफ़लाइन मोड में 100% कार्यशील" : "100% Functional in Offline Mode"}
              </span>
            </div>
