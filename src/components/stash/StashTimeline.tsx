...
export const StashTimeline = memo(function StashTimeline({ onBook }: StashTimelineProps) {
  ...
  const TIMELINE_STEPS = [
    ...
    },
    {
      ...
      subtitleEn: "Protected vehicle transit to neighborhood verified PG owner host",
    ...
    {
      step: 4,
      titleEn: "Pallet Placement at Verified PG Owner Host Node",
      ...
      icon: Layers,
      accent: "#F59E0B",
      locationEn: "Verified PG Owner Host Home Node (Secured Room)",
      ...
      detailsEn: [
        ...
        "Audited residential premises managed by verified verified PG owner citizens with zero industrial clutter.",
        "Verified PG Owner host scans receipt QR to acknowledge custody transfer and confirm pallet placement.",
      ],
      detailsHi: [
